...
@section('title', 'Review Banner Manager')
@section('page_title', 'App Review Banner Management')
    ...
    <div class="row g-4">
        ...
        <div class="col-md-4">
            <div class="card-modern">
                <h5 class="fw-bold mb-4">Upload New Review Banner</h5>
                <form action="{{ route('admin.reviews.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="extra-small text-muted mt-1">This will appear in the slider on home screen.</div>
                    </div>
                    <div class="mb-4">
                    ...
                    <button type="submit" class="btn btn-primary w-100 rounded-pill shadow-sm">
                        <i class="fa-solid fa-cloud-arrow-up me-2"></i>Upload Review Banner
                    </button>
                </form>
            </div>
        </div>
        ...
        <div class="col-md-8">
            <div class="card-modern">
                <h5 class="fw-bold mb-4">Active Review Banners ({{ $reviews->count() }})</h5>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="card border-0 shadow-sm rounded-4 overflow-hidden h-100">
                            <div class="position-relative">
                                <img src="{{ $review->image_url }}" class="card-img-top" style="height: 160px; object-fit: cover;">
                            ...
                            <div class="card-body p-3">
                                @if($review->redirect_url)
                                    <div class="d-flex align-items-center text-primary small">
                                        <i class="fa-solid fa-link me-2"></i>
                                        <span class="text-truncate">{{ $review->redirect_url }}</span>
                                    </div>
                                @else
                    ...
                    <div class="col-12 text-center py-5 text-muted">
                        ...
                        No review banners uploaded yet.
                    </div>
                    @endforelse
                </div>
            </div>
