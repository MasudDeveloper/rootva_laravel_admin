...
<div style="position: absolute; left: -9999px; top: -9999px;">
    <div id="bulk-verified-card" style="width: 420px; background: #ffffff; border-radius: 20px; padding: 30px 20px; text-align: center; font-family: 'Hind Siliguri', sans-serif; position: relative; border: 2px solid #e2e8f0; overflow: hidden; box-shadow: inset 0 0 50px rgba(0,50,200,0.05);">
        ...
        <div style="position: relative; z-index: 2;">
            ...
            <div style="position: relative; display: inline-block; margin-bottom: 20px;">
                ...
                <img id="bulk-card-img" src="" alt="Profile" style="width: 140px; height: 140px; border-radius: 50%; object-fit: cover; border: 4px solid #ffffff; box-shadow: 0 5px 15px rgba(0, 0, 0, 0.15); position: relative; z-index: 3;">
            ...
            <div style="margin-bottom: 25px;">
                <div style="display: inline-block; background: #0022aa; color: white; padding: 8px 50px; border-radius: 8px; font-weight: 800; font-size: 24px; box-shadow: 0 6px 12px rgba(0,34,170,0.3); position: relative;">
                    <span id="bulk-card-name">Name</span>
