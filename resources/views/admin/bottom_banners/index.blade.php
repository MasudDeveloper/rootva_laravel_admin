...
@section('title', 'Bottom Banner Manager')
@section('page_title', 'App Bottom Banner (Banner 2) Management')
    ...
    <div class="row g-4">
        ...
        <div class="col-md-4">
            <div class="card-modern">
                <h5 class="fw-bold mb-4">Upload New Bottom Banner</h5>
                <form action="{{ route('admin.bottom-banners.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        ...
                        <div class="extra-small text-muted mt-1">Recommended size: 1000x500px</div>
                    </div>
                    <div class="mb-4">
                    ...
                    <button type="submit" class="btn btn-primary w-100 rounded-pill shadow-sm">
                        <i class="fa-solid fa-cloud-arrow-up me-2"></i>Upload Bottom Banner
                    </button>
                </form>
            </div>
        </div>
        ...
        <div class="col-md-8">
            <div class="card-modern">
                <h5 class="fw-bold mb-4">Active Bottom Banners ({{ $banners->count() }})</h5>
                ...
                <div class="row g-3">
                        ...
                        <div class="card border-0 shadow-sm rounded-4 overflow-hidden h-100">
                            <div class="position-relative">
                                ...
                                <div class="position-absolute top-0 end-0 p-2">
                                    <form action="{{ route('admin.bottom-banners.destroy', $banner->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger btn-sm rounded-circle shadow" 
                                                onclick="return confirm('Are you sure you want to delete this bottom banner?')"
                    ...
                    <div class="col-12 text-center py-5 text-muted">
                        ...
                        No bottom banners uploaded yet.
                    </div>
                    @endforelse
                </div>
            </div>
