...
Route::prefix('admin')->name('admin.')->middleware('auth:admin')->group(function () {
    ...
    Route::middleware('permission:sub_admins')->group(function () {
        Route::get('/sub-admins', [\App\Http\Controllers\Admin\AdminUserController::class, 'index'])->name('sub-admins.index');
        Route::post('/sub-admins', [\App\Http\Controllers\Admin\AdminUserController::class, 'store'])->name('sub-admins.store');
        Route::patch('/sub-admins/{id}', [\App\Http\Controllers\Admin\AdminUserController::class, 'update'])->name('sub-admins.update');
        Route::delete('/sub-admins/{id}', [\App\Http\Controllers\Admin\AdminUserController::class, 'destroy'])->name('sub-admins.destroy');
    });
    ...
    // Microjobs (permission: microjobs)
    Route::middleware('permission:microjobs')->group(function () {
    ...
    Route::middleware('permission:leadership')->group(function () {
    ...
    Route::prefix('services')->group(function () {
        ...
        // Reselling Shop & Orders (permission: reselling)
        Route::middleware('permission:reselling')->group(function () {
        ...
        Route::middleware('permission:courses')->group(function () {
        ...
        // Leadership Rewards (permission: leadership)
        Route::middleware('permission:leadership')->group(function () {
        ...
        // SMM Submissions Management (permission: smm)
        Route::middleware('permission:smm')->prefix('smm')->name('smm.')->group(function () {
